...
Route::group(['namespace'=>'Frontend'], function (){
    ...
    Route::group(['namespace'=>'Auth'], function (){
		...
		Route::get('do-expire-otp', 'RegisterController@expireOTP')->name('do-expire-otp');
	...
	Route::group(['middleware' => 'Dashboard'], function(){
		...
		Route::post('dashboard-profile-picture-update','DashboardCandidateController@dashboardUpdateProfilePicture')->name('dashboard-profile-picture-update');
		...
		Route::get('dashboard-candidates-my-courses','DashboardCandidateController@indexMyCourses')->name('dashboard-candidates-my-courses');
		Route::get('dashboard-candidates-online-coaching','DashboardCandidateController@indexOnlineCoaching')->name('dashboard-candidates-online-coaching');
		Route::post('get-coach-available-dates','DashboardCandidateController@getCoachAvailableDates')->name('get-coach-available-dates');
		Route::post('get-coach-available-time-slots','DashboardCandidateController@getCoachAvailableTimeSlots')->name('get-coach-available-time-slots');
		Route::post('save-user-session-coach','DashboardCandidateController@saveUserSessionCoach')->name('save-user-session-coach');
		...
		Route::post('delete-cover-letter/{cl_id}','DashboardCandidateController@deleteCoverLetter')->name('delete-cover-letter');
		Route::post('delete-email-template/{e_id}','DashboardCandidateController@deleteEmailTemplate')->name('delete-email-template');
		...
		Route::get('download-cover-letter-pdf/{cl_id}','DashboardCandidateController@downloadDashboardCoverLetterPDF')->name('download-cover-letter-pdf');
		Route::post('change-resume-title','DashboardCandidateController@changeResumeTitle')->name('change-resume-title');
		Route::post('change-cover-letter-title','DashboardCandidateController@changeCoverLetterTitle')->name('change-cover-letter-title');
		Route::post('change-email-template-title','DashboardCandidateController@changeEmailTemplateTitle')->name('change-email-template-title');
	...
	Route::post('/faq-email/submit','HomeController@faqSubmit')->name('faq-email.submit');
	...
	Route::get('/email-cover-letter','HomeController@emailCoverLetter')->name('email-cover-letter');
	...
	// Cover Letter Routes
	Route::get('/cover-letter-design-template','CoverLetterController@index')->name('cover-letter-design-template');
	Route::get('/cover-letter-example','CoverLetterController@coverLetterExamples')->name('cover-letter-example');
	Route::get('/choose-cover-letters/{id}','CoverLetterController@coverLettersView')->name('choose-cover-letters');
	Route::post('/save-user-cover-letter','CoverLetterController@saveUserCoverLetter')->name('save-user-cover-letter');
	Route::post('add-cover-letter-details','CoverLetterController@addUserCoverLetterEmailFullname')->name('add-cover-letter-details');
	Route::get('/cover_letters/{id}','CoverLetterController@coverLetterPage')->name('cover_letters');
	Route::get('/cover_letters/get-cover-template/{id}','CoverLetterController@getSampleCoverTemplate');
	Route::post('/store-user-cover-letter-data','CoverLetterController@storeUserCoverLetterDetails')->name('store-user-cover-letter-data');
	Route::post('/cover_letters/generate-cover-letter-pdf','CoverLetterController@generateCoverLetterPDF')->name('generate-cover-letter-pdf');
	Route::get('/update-cover-letter/{id}','CoverLetterController@updateCoverLetter')->name('update-cover-letter');
	Route::post('/update-choose-cover-letter-template','CoverLetterController@changeCoverLetterTemplate')->name('update-choose-cover-letter-template');

	Route::get('/update-cover-letter-example/{id}','CoverLetterController@updateCoverLetterExample')->name('update-cover-letter-example');
	Route::post('/update-choose-cover-letter-example','CoverLetterController@changeCoverLetterExampleTemplate')->name('update-choose-cover-letter-example');

	// Change cover letter template color route
	Route::post('/change-cover-letter-color','CoverLetterController@changeCoverLetterColor')->name('change-cover-letter-color');

	// Email Template Routes
	Route::get('/email-cover-letter-examples','EmailTemplateController@index')->name('email-cover-letter-examples');
	Route::get('/choose-email-templates/{id}','EmailTemplateController@emailTemplatesView')->name('choose-email-templates');
	// Route::post('add-email-template-details','EmailTemplateController@addUserEmailTemplateEmailFullname')->name('add-email-template-details');
	Route::post('/save-user-email-template','EmailTemplateController@saveUserEmailTemplate')->name('save-user-email-template');
	Route::get('/email_templates/{id}','EmailTemplateController@emailTemplatePage')->name('email_templates');
	Route::post('/store-user-email-template-data','EmailTemplateController@storeUserEmailTemplateDetails')->name('store-user-email-template-data');
	...
	Route::post('/update-choose-template','ResumeController@changeResumeTemplate')->name('update-choose-template');
	...
	Route::post('/save-user-custom-section-heading','ResumeController@saveCustomSectionHeading')->name('save-user-custom-section-heading');
