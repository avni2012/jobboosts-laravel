                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <form name="blog-Edit" action="{{route('manage-blog.update',$blog->id)}}" method="Post" enctype="multipart/form-data">
                      ...
                      <div class="form-group" >
                        <label class="form-label">Blog Category</label><span class="text-danger">*</span>
                      ...
                      <div id="editor">
                        <div class="form-group ">
                          ...
                          <textarea cols="80" id="edit" name="content" rows="10">{{old('content',$blog->content)}}</textarea>
                            <script>
                      ...
                      <div class="form-group tag-c" >
                        ...
                        &nbsp;&nbsp;<a type="button" data-toggle="modal" data-target="#addTagCategory" id="addtag" href="#"><i class="fa fa-plus-circle" style="font-size:24px"></i></a>
                      ...
                      <div class="form-group ">
                          ...
                          <input type="text" name="youtube_video_link" id="youtube_video_link" class="form-control" value="{{old('youtube_video_link',$blog->youtube_video_link)}}">
                          <p>Please just enter url like <b>https://www.youtube.com/embed/ENe89j89tBA</b> and /embed is value after v= found in youtube url</p>
                          <span id="youtube_video_link_error"></span>
