...
@section('breadcrumb-title', 'Manage Notifications')
                            ...
                            <div class="col-sm-6">
                                <div class="add_staff_btn">
                                    @if(Auth::user()->can('create-notification'))
                                        <div class="add_staff_btn">
                                            <a type="button" class="btn btn-default btn-purple" href="{{route('manage-notification.create')}}">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="notificationDatatable" class="table table-bordered table-striped">
                                                <thead>
                                                <tr>
                                                    <th>No</th>
                                                    <th>title</th>
...
@section('script-js-last')
    <script src="{{asset('assets/backend/developer/developer.js')}}"></script>
@endsection
