...
@section('breadcrumb-title', 'Edit Coach')
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <form name="Coach-edit"  id="Coach-edit" action="{{route('manage-coach.update',$coach->id)}}" method="Post" data-parsley-validate enctype="multipart/form-data">
                                            @csrf
                                            {{ method_field('PATCH') }}
                                            ...
                                            <div class="text-center">
                                                <button type="submit" form="Coach-edit" class="btn btn-purple">Update Coach Details</button>
