...
@section('title', 'Manage Coach Availability')

@section('breadcrumb-title', 'Manage Coach Availability')

@section('breadcrumb-item')
    <li class="breadcrumb-item active">Manage Coach Availability</li>
@endsection
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Manage Coach Availability</h1>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="manage_Cms_page ">
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <!-- /.card-header -->
                                    <form name="availability" id="availability" action="{{route('save-coach-availability', $coach_data->id)}}" method="Post" data-parsley-validate>
                                        @csrf
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="text-center">
                                                <button type="submit" form="availability" class="btn btn-purple">Save Coach Details</button>
