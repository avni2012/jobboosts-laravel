            ...
            <section class="content ">
                <div class="container-fluid">
                    <div class="manage_staff_page">
                        <form action=" {{route('manage-users.store') }}" method="POST" data-parsley-validate>
                        @csrf
                        <div class="row">
                            <div class="col-sm-8">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input type="text" name="name" class="form-control" pattern="/^[a-zA-Z ]*$/" data-parsley-pattern-message="Please provide user's valid name." value="{{old('name')}}" required
                                                       data-parsley-required-message="Please provide users's name.">
                                                @if ($errors->has('name'))
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input type="password" name="password" class="form-control" value="{{old('password')}}" minlength="8" required data-parsley-required-message="Please provide user's password." >
                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input type="text" name="mobile_no" class="form-control" pattern="/^[0-9]*$/" required minlength="6" maxlength="16"
                                                       data-parsley-required-message="Please provide user's mobile number." data-parsley-pattern-message="Please provide user's valid mobile no." value="{{old('mobile_no')}}">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input type="text" name="email" class="form-control" value="{{old('email')}}" required data-parsley-required-message="Please provide user's email address."
                                                       data-parsley-email-message="Please provide user's valid email address.">
                                                @if ($errors->has('email'))
                                ...
                                {{--<div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address_line_1" class="form-control" placeholder="House No.,Building name" value="{{ old('address_line_1')}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address_line_2" placeholder="Road name,area,colony" class="form-control" value="{{old('address_line_2')}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address_line_3" placeholder="Landmark" class="form-control" value="{{old('address_line_3')}}">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            {{--<div class="form-group col-sm-12">
                                                ...
                                                <textarea class="form-control" name="remarks" id="remarks" cols="30"></textarea>
