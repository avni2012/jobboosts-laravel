...
@section('breadcrumb-title', 'Edit Coupon')
            ...
            <div class="row">
              <div class="col-8">
                <div class="card">
                  <!-- /.card-header -->
                  <div class="card-body">
                    <form name="Coupon-Edit" id="Coupon-Edit" action="{{route('manage-coupon.update',$coupon->id)}}" method="Post" enctype="multipart/form-data">
                      @csrf
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            ...
                            <select class="form-control" name="type" id="type">
                              ...
                              <option value="Subscription" {{ old('type',$coupon->type) == 'Subscription' ? "selected" : "" }}>Subscription</option>
                            </select>
                            @if ($errors->has('type'))
                          ...
                          <div class="col-sm-6">
                            ...
                            <input type="text" name="coupon_code" class="form-control input-capital" value="{{old('coupon_code',$coupon->coupon_code)}}">
                      ...
                      <div class="form-group ">
                        <div class="row">
                                ...
                                <div class="radio_payment_option_inner">
                                    <div class="radio_payment_radio">
                                        <label class="fancy-radio free_label">
                                            <input name="discount_type" id="fixed" value="1" type="radio" {{(old('discount_type',$coupon->discount_type) == '1') ? 'checked' : ''}}>
                                            <span><i></i>Fixed</span>
                                        </label>
                                    </div>
                                    <div class="radio_payment_radio">
                                        <label class="fancy-radio one_time_label">
                                            <input name="discount_type" id="percentage" value="2" type="radio" {{(old('discount_type',$coupon->discount_type) == '2') ? 'checked' : ''}}>
                          ...
                          <div class="col-sm-6">
                            ...
                            <input type="text" name="discount_value" class="form-control" value="{{old('discount_value',$coupon->discount_value)}}" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))">
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            ...
                            <div class="input-group date" data-provide="start_date">
                              <input type="text" class="form-control start_date" name="start_date" id="start_date" value= "{{ old('start_date',date('Y-m-d', strtotime($coupon->start_date))) }}">
                          ...
                          <div class="col-sm-6">
                            ...
                            <div class="input-group date" data-provide="end_date">
                              <input type="text" class="form-control end_date" name="end_date" id="end_date" value="{{ old('end_date',date('Y-m-d', strtotime($coupon->end_date))) }}">
                              <div class="input-group-addon">
                                  <span class="glyphicon glyphicon-th"></span>
                              </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <label class="form-label">One time use per user</label><span class="text-danger">*</span>
                              <div class="radio_payment_option">
                                <div class="radio_payment_option_inner">
                                    <div class="radio_payment_radio">
                                        <label class="fancy-radio free_label">
                                            <input name="one_time_use" id="yes" value="1" type="radio" {{(old('one_time_use',$coupon->one_time_use) == '1') ? 'checked' : ''}}>
                                            <span><i></i>Yes</span>
                                        </label>
                                    </div>
                                    <div class="radio_payment_radio">
                                        <label class="fancy-radio one_time_label">
                                            <input name="one_time_use" id="no" value="0" type="radio" {{(old('one_time_use',$coupon->one_time_use) == '0') ? 'checked' : ''}}>
                                            <span><i></i>No</span>
                                        </label>
                                    </div>
                                </div>
                          ...
                          {{--<div class="col-sm-6">
                            ...
                            <select class="form-control" name="currency" id="currency">
                                  <option value="0" @if(old('status',$coupon->currency) == 1)selected @endif>USD</option>
                                  <option value="1" @if(old('status',$coupon->currency) == 1)selected  @endif>INR</option>
                            </select>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                      <div class="text-center">
                        <button type="submit" class="btn btn-purple" form="Coupon-Edit">Save Coupon</button>
