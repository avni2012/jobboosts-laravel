...
@section('breadcrumb-title', 'Create Faq')
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  <!-- /.card-header -->
                  <div class="card-body">
                    <form name="Faq-create" action="{{route('manage-faq.store')}}" method="Post">
                      ...
                      <div class="form-group" >
                        ...
                        <select class="form-control" name="category_id" id="category_id" required>
                          ...
                          @foreach($categories as $category)
                            <option value="{{ $category->id }}" @if($category->id == old('category_id')) @endif>{{ $category->category }}</option>
                          @endforeach
                        </select>
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-purple">Save Faq</button>
