<div class="modal fade" id="emailTemplatePopup" tabindex="-1" role="dialog" aria-hidden="true" data-id="">
            ...
            <div class="modal-body">
                <div class="login-register">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active email-template-detail-form" id="candidate" role="tabpanel">
                            <form class="mt-4" method="POST" action="{{ route('add-email-template-details') }}">
                                @csrf
                                <input type="hidden" id="t_id" value="">
                                <div class="form-row">
                                    <div class="form-group col-12">
                                        <label for="Email2">Email (Used for Email Template)</label><span class="text-danger">*</span>
                                    ...
                                    <div class="form-group col-12">
                                        <label for="password2">Full Name (Used for Email Template)</label><span class="text-danger">*</span>
