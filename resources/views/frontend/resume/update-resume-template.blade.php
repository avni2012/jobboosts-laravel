...
@section('title', 'Update Resume Template')
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="cover-letter-box">
                          ...
                          <div class="cmiddle">
                            <div class="ctext choose-template" id="update_resume_template">
                              @if($template['is_available'] == 1)
                                @if($getResumeId['resume_template_name'] == $template['id'])
                                  <a class="selected-temp" disabled="">Selected</button>
                                @else
                                  <a onclick="selectUpdateResume({{ $getResumeId['id'] }}, {{ $template['id'] }})">Use this template</a>
                                @endif
                              @else
