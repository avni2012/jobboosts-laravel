<div class="modal fade" id="resumePopup" tabindex="-1" role="dialog" aria-hidden="true" data-id="">
            ...
            <div class="modal-body">
                <div class="login-register">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active resume-detail-form" id="candidate" role="tabpanel">
                            <form class="mt-4" method="POST" action="{{ route('add-resume-details') }}">
                                @csrf
                                <input type="hidden" id="t_id" value="">
                                <div class="form-row">
                                    <div class="form-group col-12">
                                        <label for="Email2">Email (Used for Resume Builder)</label><span class="text-danger">*</span>
                                    ...
                                    <div class="form-group col-12">
                                        <label for="password2">Full Name (Used for Resume Builder)</label><span class="text-danger">*</span>
