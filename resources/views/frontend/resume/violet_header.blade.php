...
<head>
	...
	<style type="text/css">		
        ...
        .w-pro-cont{width: 245px;max-width: 245px;}
		...
		<table class="w-100">
			<tbody>
				<tr class="proback">
                    ...
                    <td class="p-40 w-pro-cont position-relative" colspan="2">
                        <div class="vl-img-con">
                            <div class="v-imag-con">
                                <img src="{{ asset('/frontend/images/profile_pictures/'.$getProfilePicture['profile_image']) }}" alt="profile image" class="v-profile"> 
                            </div>
                            <div class="vl-name-c">
                                @if(isset($getResumeFullNameEmail['resume_fullname']))
                                    <h1 class="v-u-name">{{$getResumeFullNameEmail['resume_fullname']}}</h1>
                                @endif
                                @if(isset($getPersonalDetails['main_job_title']))
                                    <h2 class="v-aply-cont">{{$getPersonalDetails['main_job_title']}}</h2>
                                @endif
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="p-40 w-pro-cont position-relative" colspan="2">
                        <div class="vl-img-con">
                            <div class="v-imag-con">
                                <img src="{{ asset('/frontend/images/default_profile.jpg') }}" alt="profile image" class="v-profile"> 
                            </div>
                            <div class="vl-name-c">
                                @if(isset($getResumeFullNameEmail['resume_fullname']))
                                    <h1 class="v-u-name">{{$getResumeFullNameEmail['resume_fullname']}}</h1>
                ...
                <tr>
                    <td class="wht-back w-pro-cont ver-alg-top">
                        
                    </td>
                    <td class="ver-alg-top back-dark" style="padding-top: 25px; width: 458px;">
