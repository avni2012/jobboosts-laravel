    var myState = {
        ...
        if(window.location.href == base_url + '/cover_letters/' + r_id){
            var pdf1 = base_url + '/frontend/cover_letters_pdf/' + nameData.resume_fullname + '_' + user + '_' + r_id + '.pdf';
            var pdf2 = base_url + '/frontend/cover_letters_pdf/' + nameData.resume_fullname + '_' + user + '_' + r_id + '.pdf';
        }else{
